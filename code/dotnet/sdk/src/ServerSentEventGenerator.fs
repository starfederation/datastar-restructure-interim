...
type ServerSentEventGenerator (context:IServerSentEventContext) =
    ...
    interface IServerSentEventGenerator with
        ...
        member this.RenderFragment(fragment, options) =
            let rfo =
                { MergeMode = options.MergeMode
                  Selector = Utility.ValueOption.fromNullable options.Selector
                  SettleDuration = options.SettleDuration
                  UseViewTransition = options.UseViewTransition }
            ServerSentEvent.renderFragment this.Context EventOptions.defaults rfo fragment
        member this.RenderFragment(fragment, options, eventOptions) =
            let rfo =
                { MergeMode = options.MergeMode
                  Selector = Utility.ValueOption.fromNullable options.Selector
                  SettleDuration = options.SettleDuration
        ...
        member this.RemoveFragment(selector, options) = ServerSentEvent.removeFragment this.Context EventOptions.defaults { SettleDuration = options.SettleDuration; UseViewTransition = options.UseViewTransition } selector
        member this.RemoveFragment(selector, options, eventOptions) = ServerSentEvent.removeFragment this.Context eventOptions.AsEventOptions { SettleDuration = options.SettleDuration; UseViewTransition = options.UseViewTransition } selector
        member this.PatchStore(dataStorePatch) = ServerSentEvent.patchStore this.Context EventOptions.defaults false dataStorePatch
        member this.PatchStore(dataStorePatch:string, eventOptions:ServerSentEventOpts) = ServerSentEvent.patchStore this.Context eventOptions.AsEventOptions false dataStorePatch
        ...
        member this.PatchStore(dataStorePatch:string, onlyIfMissing:bool, eventOptions:ServerSentEventOpts) = ServerSentEvent.patchStore this.Context eventOptions.AsEventOptions onlyIfMissing dataStorePatch
        ...
        member this.RemoveFromStore(dataStorePaths, eventOptions) = ServerSentEvent.removeFromStore this.Context eventOptions.AsEventOptions dataStorePaths
        member this.Redirect(uri) = ServerSentEvent.redirect this.Context EventOptions.defaults uri
        member this.Redirect(uri, eventOptions) = ServerSentEvent.redirect this.Context eventOptions.AsEventOptions uri
        member this.Console(consoleMode, message) = ServerSentEvent.console this.Context EventOptions.defaults consoleMode message
        member this.Console(consoleMode, eventOptions, message) = ServerSentEvent.console this.Context eventOptions.AsEventOptions consoleMode message
