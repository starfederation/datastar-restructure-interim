...
type ServerSentEventGenerator (context:IServerSentEventContext) =
    ...
    member this.RemoveSignals = ServerSentEvent.removeFromStore this.Context EventOptions.defaults
    ...
    interface IServerSentEventGenerator with
        ...
        member this.RemoveSignals(dataStorePaths) = ServerSentEvent.removeFromStore this.Context EventOptions.defaults dataStorePaths
        member this.RemoveSignals(dataStorePaths, eventOptions) = ServerSentEvent.removeFromStore this.Context eventOptions.AsOptions dataStorePaths
