import { DATASTAR } from "library/engine/const";
import {
    ActionMethod,
    ActionPlugin,
    AttributeContext,
    ExpressionFunction,
} from "library/engine/types";
import {
    INDICATOR_CLASS,
    INDICATOR_LOADING_CLASS,
} from "library/plugins/attributes/backend/fetch-indicator";
import {
    remoteSignals,
    storeFromPossibleContents,
} from "library/utils/signals";
import {
    docWithViewTransitionAPI,
    supportsViewTransitions,
} from "library/utils/view-transitions";
import {
    fetchEventSource,
    FetchEventSourceInit,
} from "library/vendored/fetch-event-source";
import { idiomorph } from "library/vendored/idiomorph";
import { Signal } from "library/vendored/preact-core";
