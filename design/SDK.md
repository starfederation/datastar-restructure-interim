...
5. The function ***must*** include the fragment content at the ***end*** of the event data, with each line prefixed with `data: fragment `.
...
2. The function ***must*** include the store patches at the ***end*** of the event data, with each line prefixed with `data: store `.
