...
5. The function ***must*** include the fragment content in the event data, with each line prefixed with `fragment `.
...
2. The function ***must*** include the store patches in the event data, with each line prefixed with `store `.
